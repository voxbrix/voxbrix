...
impl FromDescriptor for Gravity {
    type Descriptor = Gravity;

    const COMPONENT_NAME: &str = "gravity";
...
pub type GravityDimensionKindComponent = DimensionKindComponent<Gravity>;
...
pub fn density_gravity_scale(actor_density: f32, environment_density: f32) -> f32 {
